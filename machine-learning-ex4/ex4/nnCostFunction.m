...
penalize1 = sum(sum(Theta1_wo_bias.^2));
penalize2 = sum(sum(Theta2_wo_bias.^2));
penalize = penalize1 + penalize2;
J = J + lambda/(2*m) * penalize;

% Back prop.
d3 = a3 - y_matrix;
d2 = (d3 * Theta2_wo_bias) .* sigmoidGradient(z2);
Delta1 = d2' * a1;
Delta2 = d3' * a2;

Theta1_unreg_grad = Delta1/m;
Theta2_unreg_grad = Delta2/m;
